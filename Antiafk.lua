local Hutao = Instance.new("ScreenGui")
...
Hutao.Name = "Hutao"
Hutao.Parent = game.CoreGui
Hutao.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
Credits.Text = "Made by Hutaohubs"
